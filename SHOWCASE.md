...
1.  **The framework exists and is pinnable.** A tagged release of `evo-core` the distribution can depend on. For this distribution: evo-core v0.1.7.
...
-   Location: `github.com/foonerd/evo-core`, pinned at `v0.1.7`.
...
-   **Plugin artefact.** One plugin directory under `/opt/evo/plugins/<name>/` (manifest and binary). Common.
