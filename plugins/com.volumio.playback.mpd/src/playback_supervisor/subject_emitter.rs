...
//!
//! Per Phase 3.4 of Milestone 3, the playback warden announces
//! `track` and `album` subjects and the `album_of` relation
//! between them whenever MPD reports a current song. This gives
//! Milestone 4's album-art respondent a graph to walk from "what
//! is playing right now" to the artwork that belongs to it.
//!
//! # Addressing schemes
//!
...
//! (`album_of`) are declared in `catalogue/volumio.toml`. The
